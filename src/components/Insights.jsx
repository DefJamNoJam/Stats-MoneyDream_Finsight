// ✅ 수정된 Insights.jsx - InsightsPanel 형식 유지 + GPT 분석 + 추가 변수 연동
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          ...
          <Box mb={4}>
            ...
            <Box sx={{ overflowX: 'auto', maxHeight: 360, border: '1px solid #ddd', borderRadius: 2 }}>
              <Table size="small" stickyHeader>
                <TableHead>
                  <TableRow sx={{ backgroundColor: '#eef3f8' }}>
                    <TableCell sx={{ fontWeight: 'bold' }}>Pair</TableCell>
                    <TableCell sx={{ fontWeight: 'bold' }}>Buy_Date</TableCell>
                    <TableCell sx={{ fontWeight: 'bold' }}>Sell_Date</TableCell>
                    <TableCell sx={{ fontWeight: 'bold' }} align="right">Holding_Time</TableCell>
                    <TableCell sx={{ fontWeight: 'bold' }} align="right">Buy_Price</TableCell>
                    <TableCell sx={{ fontWeight: 'bold' }} align="right">Sell_Price</TableCell>
